...
SECRET_KEY = 'wws6o#gvjlh8c84l1)24)earc5orx!ghw1#e5a#xr#)xzufbw='
...
ROOT_URLCONF = 'nieuwsverschillen.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'nieuwsverschillen.wsgi.application'
...
NIEUWSVERSCHILLEN_PARSERS = [
    'nieuwsverschillen.parsers.nunl.NuNLParser',
